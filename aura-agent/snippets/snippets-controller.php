...
class Aura_Agent_Custom {
	...
	public function check_existing_snippets_callback() {
		...
		$aura_admin_functions = new Aura_Supercommerce_Custom( $this->plugin_name, $this->version, AURA_AGENT_SLUG );
	 ...
	 * @see - snippet_form_submit AND associated action - aap_snippet_form_submit
	 * @see   <input name="aap_snippets[]" />
	...
	public function output_snippet_switches(){
		...
		if ($existing_snippets) : ?>
			...
			<div class="snippet-switch row__switch">
				<div class="col__switch">
					...
					<input type="checkbox" id="<?php echo $value->name; ?>" name="aap_snippets[]" value="<?php echo $value->name; ?>" <?php checked( 1 == $value->status ); ?>><span class="checkmark"></span>
					  </label>
				</div>
				<div class="col__switch">
		...
		<?php } ?>
			...
			<input type="hidden" name="action" value="aap_snippet_form_submit">
	...
	public function aap_snippet_form_submission(){
		
		$aura_admin_functions = new Aura_Supercommerce_Custom( $this->plugin_name, $this->version, AURA_AGENT_SLUG );

		$submitted_snippets = false;
		// sanitize the input
		if (isset($_GET['aap_snippets'])) {
			$submitted_snippets = $_GET['aap_snippets'];
		}
		...
		wp_redirect(admin_url('admin.php?page=aura_agent'));
	...
	*/
	...
	public function aap_refresh_snippets() {
	 ...
	 * @FLAG - Migration, migrate
	 * @property wp_redirect - admin.php?page=aura_agent
	 * @property AURA_AGENT_SLUG
	 */


	public function aap_rebuild_snippets() {
