		...
		<ul id="add_to_wishlist_popup_<?php echo esc_attr( $product_id ); ?>_<?php echo esc_attr( $unique_id ); ?>" class="yith-wcwl-dropdown">
			<?php foreach ( $lists as $list ) : ?>
				...
				<li>
					<a href="
					<?php
					echo YITH_WCWL()->get_add_to_wishlist_url(
						$product_id,
						array(
					...
					?>
								" rel="nofollow" data-product-id="<?php echo esc_attr( $product_id ); ?>" data-product-type="<?php echo esc_attr( $product_type ); ?>" data-original-product-id="<?php echo esc_attr( $parent_product_id ); ?>" data-wishlist-id="<?php echo esc_attr( $list->get_id() ); ?>" class="add_to_wishlist"><?php echo esc_html( $list->get_formatted_name() ); ?></a>
				</li>
			<?php endforeach; ?>
		</ul>
