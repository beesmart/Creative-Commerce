...
<!-- WISHLIST GRID -->
<ul
	class="wishlist_table wishlist_view shop_table cart images_grid responsive products columns-<?php echo esc_attr( apply_filters( 'yith_wcwl_wishlist_view_images_columns', wc_get_loop_prop( 'columns' ) ) ); ?> <?php echo $no_interactions ? 'no-interactions' : ''; ?> <?php echo $enable_drag_n_drop ? 'sortable' : ''; ?>"
