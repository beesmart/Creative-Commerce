	...
	class YITH_WCWL_Admin_Premium extends YITH_WCWL_Admin {
		...
		public function admin_notices() {
			if ( isset( $_GET['email_sent'] ) ) {
				$res = is_numeric( $_GET['email_sent'] ) ? intval( $_GET['email_sent'] ) : sanitize_text_field( wp_unslash( $_GET['email_sent'] ) );
				...
				if ( ! empty( $promotion_email_draft ) ) {
					...
					<div class="updated fade">
						<p>
							...
							<a href="#" class="restore-draft button-primary" data-draft="<?php echo esc_attr( htmlspecialchars( json_encode( $promotion_email_draft ) ) ); ?>">
								<?php esc_html_e( 'Continue', 'yith-woocommerce-wishlist' ); ?>
							</a>
