...
namespace Barn2\Plugin\WC_Filters\Dependencies\Psr\Log\Test;

use Barn2\Plugin\WC_Filters\Dependencies\Psr\Log\LoggerInterface;
use Barn2\Plugin\WC_Filters\Dependencies\Psr\Log\LogLevel;
use Barn2\Plugin\WC_Filters\Dependencies\PHPUnit\Framework\TestCase;
/**
...
abstract class LoggerInterfaceTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('Barn2\\Plugin\\WC_Filters\\Dependencies\\Psr\\Log\\LoggerInterface', $this->getLogger());
    }
    /**
    ...
    public function testObjectCastToString()
    {
        if (\method_exists($this, 'createPartialMock')) {
            $dummy = $this->createPartialMock('Barn2\\Plugin\\WC_Filters\\Dependencies\\Psr\\Log\\Test\\DummyTest', array('__toString'));
        } else {
            $dummy = $this->getMock('Barn2\\Plugin\\WC_Filters\\Dependencies\\Psr\\Log\\Test\\DummyTest', array('__toString'));
        }
