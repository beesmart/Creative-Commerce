...
namespace Barn2\Plugin\WC_Filters\Dependencies\Illuminate\Database\Migrations;

use Barn2\Plugin\WC_Filters\Dependencies\Doctrine\DBAL\Schema\SchemaException;
...
use Barn2\Plugin\WC_Filters\Dependencies\Illuminate\Database\Events\MigrationEnded;
use Barn2\Plugin\WC_Filters\Dependencies\Illuminate\Database\Events\MigrationsEnded;
use Barn2\Plugin\WC_Filters\Dependencies\Illuminate\Database\Events\MigrationsStarted;
use Barn2\Plugin\WC_Filters\Dependencies\Illuminate\Database\Events\MigrationStarted;
use Barn2\Plugin\WC_Filters\Dependencies\Illuminate\Database\Events\NoPendingMigrations;
...
use ReflectionClass;
use Barn2\Plugin\WC_Filters\Dependencies\Symfony\Component\Console\Output\OutputInterface;
class Migrator
{
    /**
    ...
    protected function resetMigrations(array $migrations, array $paths, $pretend = \false)
    {
        ...
        $migrations = \Barn2\Plugin\WC_Filters\Helpers::collect($migrations)->map(function ($m) {
    ...
    public function usingConnection($name, callable $callback)
    {
        ...
        return \Barn2\Plugin\WC_Filters\Helpers::tap($callback(), function () use($previousConnection) {
