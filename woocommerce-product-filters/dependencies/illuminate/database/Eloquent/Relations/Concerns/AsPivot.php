...
trait AsPivot
{
    ...
    public function delete()
    {
        ...
        $this->touchOwners();
        return \Barn2\Plugin\WC_Filters\Helpers::tap($this->getDeleteQuery()->delete(), function () {
            $this->exists = \false;
    ...
    {
        if (!isset($this->table)) {
            $this->setTable(\str_replace('\\', '', Str::snake(Str::singular(\Barn2\Plugin\WC_Filters\Helpers::class_basename($this)))));
        }
        return $this->table;
    }
    /**
