...
trait InteractsWithPivotTable
{
    ...
    {
        return $this->sync(\Barn2\Plugin\WC_Filters\Helpers::collect($this->parseIds($ids))->mapWithKeys(function ($id) use($values) {
            return [$id => $values];
        }), $detaching);
    }
    /**
    ...
    {
        return \Barn2\Plugin\WC_Filters\Helpers::collect($records)->mapWithKeys(function ($attributes, $id) {
