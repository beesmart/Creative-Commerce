...
abstract class Relation
{
    ...
    {
        return \Barn2\Plugin\WC_Filters\Helpers::collect($models)->map(function ($value) use($key) {
    ...
    {
        return $model->getKeyName() === \Barn2\Plugin\WC_Filters\Helpers::last(\explode('.', $key)) && \in_array($model->getKeyType(), ['int', 'integer']) ? 'whereIntegerInRaw' : 'whereIn';
    }
    /**
