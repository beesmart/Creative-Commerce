...
use Barn2\Plugin\WC_Filters\Dependencies\Illuminate\Database\Eloquent\RelationNotFoundException;
...
trait QueriesRelationships
{
    ...
    public function whereBelongsTo($related, $relationshipName = null, $boolean = 'and')
    {
        if ($relationshipName === null) {
            $relationshipName = Str::camel(\Barn2\Plugin\WC_Filters\Helpers::class_basename($related));
        }
        try {
