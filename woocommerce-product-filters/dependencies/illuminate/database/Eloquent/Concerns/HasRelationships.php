...
use Closure;
use Barn2\Plugin\WC_Filters\Dependencies\Illuminate\Database\ClassMorphViolationException;
...
use Barn2\Plugin\WC_Filters\Dependencies\Illuminate\Database\Eloquent\Relations\HasOneThrough;
use Barn2\Plugin\WC_Filters\Dependencies\Illuminate\Database\Eloquent\Relations\MorphMany;
use Barn2\Plugin\WC_Filters\Dependencies\Illuminate\Database\Eloquent\Relations\MorphOne;
use Barn2\Plugin\WC_Filters\Dependencies\Illuminate\Database\Eloquent\Relations\MorphTo;
use Barn2\Plugin\WC_Filters\Dependencies\Illuminate\Database\Eloquent\Relations\MorphToMany;
...
trait HasRelationships
{
    ...
    public function joiningTable($related, $instance = null)
    {
        ...
        $segments = [$instance ? $instance->joiningTableSegment() : Str::snake(\Barn2\Plugin\WC_Filters\Helpers::class_basename($related)), $this->joiningTableSegment()];
    ...
    {
        return Str::snake(\Barn2\Plugin\WC_Filters\Helpers::class_basename($this));
    }
    /**
    ...
    {
        return \Barn2\Plugin\WC_Filters\Helpers::tap(new $class(), function ($instance) {
