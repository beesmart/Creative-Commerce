...
namespace Barn2\Plugin\WC_Filters\Dependencies\Illuminate\Database\Connectors;

use Barn2\Plugin\WC_Filters\Dependencies\Doctrine\DBAL\Driver\PDOConnection;
use Exception;
use Barn2\Plugin\WC_Filters\Dependencies\Illuminate\Database\DetectsLostConnections;
use PDO;
use Throwable;
class Connector
{
