...
use Barn2\Plugin\WC_Filters\Dependencies\Doctrine\DBAL\Connection as DoctrineConnection;
use Barn2\Plugin\WC_Filters\Dependencies\Doctrine\DBAL\Types\Type;
use Exception;
use Barn2\Plugin\WC_Filters\Dependencies\Illuminate\Contracts\Events\Dispatcher;
use Barn2\Plugin\WC_Filters\Dependencies\Illuminate\Database\Events\QueryExecuted;
use Barn2\Plugin\WC_Filters\Dependencies\Illuminate\Database\Events\StatementPrepared;
use Barn2\Plugin\WC_Filters\Dependencies\Illuminate\Database\Events\TransactionBeginning;
use Barn2\Plugin\WC_Filters\Dependencies\Illuminate\Database\Events\TransactionCommitted;
use Barn2\Plugin\WC_Filters\Dependencies\Illuminate\Database\Events\TransactionRolledBack;
use Barn2\Plugin\WC_Filters\Dependencies\Illuminate\Database\Query\Builder as QueryBuilder;
use Barn2\Plugin\WC_Filters\Dependencies\Illuminate\Database\Query\Expression;
use Barn2\Plugin\WC_Filters\Dependencies\Illuminate\Database\Query\Grammars\Grammar as QueryGrammar;
use Barn2\Plugin\WC_Filters\Dependencies\Illuminate\Database\Query\Processors\Processor;
use Barn2\Plugin\WC_Filters\Dependencies\Illuminate\Database\Schema\Builder as SchemaBuilder;
...
class Connection implements ConnectionInterface
{
    ...
    {
        return \class_exists('Barn2\\Plugin\\WC_Filters\\Dependencies\\Doctrine\\DBAL\\Connection');
    }
    /**
