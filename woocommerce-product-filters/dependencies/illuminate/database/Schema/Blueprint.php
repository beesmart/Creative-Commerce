...
use Barn2\Plugin\WC_Filters\Dependencies\Illuminate\Database\Schema\Grammars\Grammar;
use Barn2\Plugin\WC_Filters\Dependencies\Illuminate\Database\SQLiteConnection;
...
class Blueprint
{
    ...
    {
        return \Barn2\Plugin\WC_Filters\Helpers::collect($this->commands)->filter(function ($command) use($names) {
    ...
    {
        return \Barn2\Plugin\WC_Filters\Helpers::collect($this->commands)->contains(function ($command) {
    ...
    {
        return !\is_null(\Barn2\Plugin\WC_Filters\Helpers::collect($this->getAddedColumns())->first(function ($column) {
    ...
    public function autoIncrementingStartingValues()
    {
        ...
        return \Barn2\Plugin\WC_Filters\Helpers::collect($this->getAddedColumns())->mapWithKeys(function ($column) {
