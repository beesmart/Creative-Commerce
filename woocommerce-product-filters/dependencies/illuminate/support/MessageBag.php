...
use Barn2\Plugin\WC_Filters\Dependencies\Illuminate\Contracts\Support\MessageBag as MessageBagContract;
use Barn2\Plugin\WC_Filters\Dependencies\Illuminate\Contracts\Support\MessageProvider;
...
class MessageBag implements Jsonable, JsonSerializable, MessageBagContract, MessageProvider
{
    ...
    {
        return \Barn2\Plugin\WC_Filters\Helpers::collect($this->messages)->filter(function ($messages, $messageKey) use($key) {
    ...
    {
        return \Barn2\Plugin\WC_Filters\Helpers::collect((array) $messages)->map(function ($message) use($format, $messageKey) {
