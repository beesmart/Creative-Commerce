...
class Settings_Util
{
    ...
    {
        $links = \apply_filters('barn2_plugins_title_links', ['doc' => ['url' => $plugin->get_documentation_url(), 'label' => __('Documentation', 'woocommerce-product-filters'), 'target' => '_blank'], 'support' => ['url' => $plugin->get_support_url(), 'label' => __('Support', 'woocommerce-product-filters'), 'target' => '_blank']], $plugin);
