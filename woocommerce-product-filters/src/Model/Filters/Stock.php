 ...
 */
class Stock extends Filter implements Indexable_Interface, Filterable_Interface, Countable_Interface, Preloadable_Interface {
	...
	public function generate_index_data( array $defaults, string $post_id ) {
		...
		// Do not use is_in_stock() otherwise it'll include products on backorder too.
		if ( $product->get_stock_status() === 'instock' ) {
			$defaults['facet_value']         = 1;
			$defaults['facet_display_value'] = __( 'In stock', 'woocommerce-product-filters' );
