...
class Aura_dual_engine_Custom {
	...
	public function check_existing_snippets_callback() {
		...
		$aura_admin_functions = new Aura_Supercommerce_Custom( $this->plugin_name, $this->version, AURA_DUAL_ENGINE_SLUG );
	 ...
	 * @see - snippet_form_submit AND associated action - ade_snippet_form_submit
	 * @see   <input name="ade_snippets[]" />
	...
	public function output_snippet_switches(){
		...
		if ($existing_snippets) : ?>
			...
			<div class="snippet-switch row__switch">
				<div class="col__switch">
					...
					<input type="checkbox" id="<?php echo $value->name; ?>" name="ade_snippets[]" value="<?php echo $value->name; ?>" <?php checked( 1 == $value->status ); ?>><span class="checkmark"></span>
					  </label>
				</div>
				<div class="col__switch">
		...
		<?php } ?>
			...
			<input type="hidden" name="action" value="ade_snippet_form_submit">
	 ...
	 * @since 1.0.0
	 * @FLAG - Migration, migrate
	 * @property wp_redirect - admin.php?page=aura-dual-engine
	 * 
	 */

	public function ade_snippet_form_submission(){
		
		$aura_admin_functions = new Aura_Supercommerce_Custom( $this->plugin_name, $this->version, AURA_DUAL_ENGINE_SLUG );

		$submitted_snippets = false;
		// sanitize the input
		if (isset($_GET['ade_snippets'])) {
			$submitted_snippets = $_GET['ade_snippets'];
		}
		...
		wp_redirect(admin_url('admin.php?page=aura-dual-engine'));
	...
	*/
	...
	public function ade_refresh_snippets() {
	 ...
	 * @FLAG - Migration, migrate
	 * @property wp_redirect - admin.php?page=aura-dual-engine
	 * @property AURA_DUAL_ENGINE_SLUG
	 */


	public function ade_rebuild_snippets() {
